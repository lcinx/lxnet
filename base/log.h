...
#define filelog_every_flush(self, flag)									\
	_filelog_every_flush_(self, enum_log_type_log, (flag))
...
#define log_set_directory(directory)									\
	_filelog_set_directory_(g_filelog_obj_, enum_log_type_log, (directory));\
	_filelog_set_directory_(g_filelog_obj_, enum_log_type_error, (directory))
...
#define log_every_flush(flag)											\
	_filelog_every_flush_(g_filelog_obj_, enum_log_type_log, flag)
